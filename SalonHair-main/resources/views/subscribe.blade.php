...
<div class="w-full h-screen" style="background-image: url('https://source.unsplash.com/sbZi_DLSjzo');">
    <div class="w-full h-screen flex flex-col items-center justify-between bg-black bg-opacity-70 py-8">
        <div class="flex-1 flex flex-col items-center justify-center">
            <div class="bg-white bg-opacity-10 px-4 py-2 rounded-xl flex items-center justify-center text-cyan-100 space-x-2 lg:space-x-4">
                ...
                <span class="text-xl lg:text-2xl xl:text-3xl font-bold">Hair Studio</span>
            </div>
            <h1 class="text-6xl lg:text-7xl xl:text-8xl text-gray-200 tracking-wider font-bold font-serif mt-12 text-center">Subscribe Us</h1>
            <div class="flex flex-col items-center space-y-4 mt-24">
                <p class="text-gray-300 uppercase text-center text-sm">By this you can get news Updates via </p>
                <p class="text-gray-300 uppercase text-center text-sm"> Email And You can get up to 50% discounts</p>
                <form action="/subcribe" method="post" class="w-full flex items-center" >
                    @csrf
                    <input type="text" name="email" id="email" class="form-control w-72 p-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded-tl rounded-bl text-sm" placeholder="Email" autocomplete="off">
                    <input type="submit" value="Subscribe" class="btn btn-successbg-blue-600 hover:bg-blue-700 py-2 px-6 text-gray-100 border border-blue-600 rounded-tr rounded-br text-sm">
                </form>
            </div>
        </div>
